      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <article className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:text-gray-700">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-4">
              Created a comprehensive educational platform offering resources,
              tutorials, and interactive content for computer science students
        ...
        <article className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:text-gray-700">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-4">
              Created a full-stack expense tracking application using React for
              the frontend and Node.js with Express for the backend, enabling
              users to monitor and manage their finances effectively.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/20">
                React
        ...
        <article className="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:text-gray-700">
          <div className="aspect-video bg-gray-100 dark:bg-gray-700 overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
              <Link
                className="p-2 bg-white rounded-full hover:bg-primary hover:text-white transition-colors"
                href="https://github.com/ABA-aadarsh/Vault-Reader"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Github></Github>
              ...
              <Link
                className="p-2 bg-white rounded-full hover:bg-primary hover:text-white transition-colors"
                href="https://vault-reader.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <ExternalLink></ExternalLink>
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-4">
              A minimal, modern, cross-platform synced e-book reader with
              offline first and self host in supabase.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/20">
                Next.js
